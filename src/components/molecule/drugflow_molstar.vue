<template>
  <div
    ...
    :class="{ 'fixed inset-0 z-50 w-screen h-screen': full_screen_type }"
  >
    <div
      :id="canvas_id"
      ref="molstar_ref"
      class="w-full h-full min-w-[300px] min-h-[300px]"
      :class="{
        drugflow_molstar_no_sequence: !props.if_sequence_panel,
        drugflow_molstar: true
      }"
    />

    <div v-show="props.show_tool && show_tool" class="absolute top-2 w-full">
          ...
          <Popover>
            ...
            <PopoverContent class="w-auto p-2">
              ...
              <RadioGroup
                ...
                @update:model-value="set_granularity"
              >
                <div class="flex items-center space-x-2">
                  <RadioGroupItem id="chain" value="chain" />
                  <Label for="chain">Chain</Label>
                </div>
                <div class="flex items-center space-x-2">
                  <RadioGroupItem id="residue" value="residue" />
                  <Label for="residue">Residue</Label>
                </div>
                <div class="flex items-center space-x-2">
                  <RadioGroupItem id="element" value="element" />
            ...
            <PopoverContent class="w-auto p-2">
              ...
              <div class="flex flex-col space-y-1">
                ...
                <div class="flex items-center space-x-2">
                  ...
                  <Button size="sm" variant="default" @click="expand_selection"
                    >OK</Button
                  >
                </div>
              </div>
          ...
          <Popover>
            ...
            <PopoverContent class="w-auto p-2">
              ...
              <RadioGroup
                v-model="background"
                class="flex flex-col space-y-1"
                @update:model-value="change_background"
              >
                <div class="flex items-center space-x-2">
                ...
                <div class="flex items-center space-x-2">
                  <RadioGroupItem id="bg-black" value="black" />
          ...
          <Popover>
            ...
            <PopoverContent class="w-auto p-2">
              ...
              <RadioGroup
                v-model="chain_repr"
                class="flex flex-col space-y-1"
                @update:model-value="change_repr"
              >
                <div class="flex items-center space-x-2">
                  <RadioGroupItem id="repr-cartoon" value="cartoon" />
                  <Label for="repr-cartoon">Cartoon</Label>
                </div>
                <div class="flex items-center space-x-2">
                  <RadioGroupItem id="repr-bs" value="bs" />
                  <Label for="repr-bs">Ball & Stick</Label>
                </div>
                <div class="flex items-center space-x-2">
                  <RadioGroupItem id="repr-sf" value="sf" />
                  <Label for="repr-sf">Spacefill</Label>
                </div>
                <div class="flex items-center space-x-2">
                  <RadioGroupItem id="repr-line" value="line" />
  ...
  await molstar_ref.value.viewerInstance.load_tree(
    {
      ...
      isBinary: input_params.is_binary,
      pdb_string: input_params.input,
      if_render: input_params.if_render,
      render_type: input_params.render_type,
      render_id: input_params.render_id,
      ligand_name: input_params.ligand_name,
      ligand_site: input_params.ligand_site
    },
